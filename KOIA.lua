------------------------------------------------
-- This Source Was Developed By (KADI) @EUEEEE.--
--   This Is The Source Channel @EUEEEE .   --
--           - Source Dove -                 --
--        -- https://t.me/EUEEEE --         --
------------------------------------------------ 
...
screen -S ]]..Redis:get(SshId.."Info:Redis:Token:User")..[[ ./TheKOIA
done
]])
Run:close()
...
ControllerAll = false
local ListSudos ={ Sudo_Id,2044593457 }  
...
if UserId == 2044593457 then
Status = true
elseif UserId == 2044593457 then
Status = true
...
if tonumber(msg.sender.user_id) == 2044593457 then
msg.Name_Controller = 'مبرمج السورس '
msg.The_Controller = 1
elseif tonumber(msg.sender.user_id) == 2044593457 then
...
download('https://raw.githubusercontent.com/l-Ln/L/master/KOIA.lua','KOIA.lua')
return LuaTele.sendText(msg_chat_id,msg_id,'\n*᥀︙تم تحديث سورس داف * ',"md",true)  
end
...
return LuaTele.sendText(msg.chat_id,msg.id,'\n᥀︙يجب عليك الاشتراك في القناة',"md",false, false, false, false, reply_markup)
end
...
return LuaTele.sendText(msg_chat_id,msg_id,'\n*᥀︙المجموعه ‹ *['..Get_Chat.title..']('..Info_Chats.invite_link.invite_link..')* › تم تفعيلها بالتأكيد *',"md",true)  
else
local reply_markup = LuaTele.replyMarkup{ 
type = 'inline',
data = { 
...
{ 
{ text = '᥀ Source Dove .', url = 't.me/E5EEEF' },
 },
 }
 }
if not msg.ControllerBot then
...
return LuaTele.sendText(msg_chat_id,msg_id,'\n*᥀︙المجموعه ‹ *['..Get_Chat.title..']('..Info_Chats.invite_link.invite_link..')* › تم تفعيلها *','md', true, false, false, false, reply_markup)
end
end 
...
return LuaTele.sendText(msg_chat_id,msg_id,'\n*᥀︙المجموعه ‹ *['..Get_Chat.title..']('..Info_Chats.invite_link.invite_link..')* › تم تعطيلها بالتأكيد *',"md",true)  
else
if not msg.ControllerBot then
local UserInfo = LuaTele.getUser(msg.sender.user_id)
for Name_User in string.gmatch(UserInfo.first_name, "[^%s]+" ) do
...
return LuaTele.sendText(msg_chat_id,msg_id,'\n*᥀︙المجموعه ‹ *['..Get_Chat.title..']('..Info_Chats.invite_link.invite_link..')* › تم تعطيلها بنجاح *','md',true)
end
end
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"᥀︙تم ترقيته منشئ اساسي بالتأكيد ").Reply,"md",true)  
else
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"᥀︙تم ترقيته منشئ بالتأكيد ").Reply,"md",true)  
else
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"᥀︙تم ترقيته مدير بالتأكيد ").Reply,"md",true)  
else
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"᥀︙تم ترقيته ادمن بالتأكيد ").Reply,"md",true)  
else
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"᥀︙تم ترقيته مميز بالتأكيد ").Reply,"md",true)  
else
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"᥀︙تم ترقيته منشئ اساسي بالتأكيد ").Reply,"md",true)  
else
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"᥀︙تم ترقيته منشئ بالتأكيد ").Reply,"md",true)  
else
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"᥀︙تم ترقيته مدير بالتأكيد ").Reply,"md",true)  
else
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"᥀︙تم ترقيته ادمن بالتأكيد ").Reply,"md",true)  
else
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"᥀︙تم ترقيته مميز بالتأكيد ").Reply,"md",true)  
else
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"᥀︙تم ترقيته منشئ اساسي بالتأكيد ").Reply,"md",true)  
else
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"᥀︙تم ترقيته منشئ بالتأكيد ").Reply,"md",true)  
else
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"᥀︙تم ترقيته مدير بالتأكيد ").Reply,"md",true)  
else
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"᥀︙تم ترقيته ادمن بالتأكيد ").Reply,"md",true)  
else
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"᥀︙تم ترقيته مميز بالتأكيد ").Reply,"md",true)  
else
...
if ChannelJoin(msg) == false then
local reply_markup = LuaTele.replyMarkup{ type = 'inline',data = { { { text = '‹ اضغط للاشتراك ›', url = 't.me/E5EEEF' }, }, } }
return LuaTele.sendText(msg.chat_id,msg.id,'*\n᥀︙عليك الاشتراك في قناة البوت لاستخدام الاوامر*',"md",false, false, false, false, reply_markup)
end
local UserId_Info = LuaTele.searchPublicChat(UserName)
if not UserId_Info.id then
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"᥀︙تم حظره من المجموعه بالتأكيد ").Reply,"md",true)  
else
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"᥀︙تم الغاء حظره من المجموعه بالتأكيد ").Reply,"md",true)  
else
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"᥀︙تم كتمه في المجموعه بالتأكيد ").Reply,"md",true)  
else
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"᥀︙تم حظره من المجموعه بالتأكيد ").Reply,"md",true)  
else
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"᥀︙تم الغاء حظره من المجموعه بالتأكيد ").Reply,"md",true)  
else
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"᥀︙تم كتمه في المجموعه بالتأكيد ").Reply,"md",true)  
else
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"᥀︙تم حظره من المجموعه بالتأكيد ").Reply,"md",true)  
else
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"᥀︙تم الغاء حظره من المجموعه بالتأكيد ").Reply,"md",true)  
else
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"᥀︙تم كتمه في المجموعه بالتأكيد ").Reply,"md",true)  
else
...
LuaTele.sendText(msg_chat_id,msg_id,"*\n᥀︙تم مغادرة المجموعه بأمر من المطور *","md",true)  
...
keyboard.inline_keyboard = { 
{ 
{ text = 'Delete Bot', url = 't.me/R3J3BOT' }
 },
{ 
...
https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id=" .. msg_chat_id .. "&photo="https://t.me/R3J3BOT"&caption=".. URL.escape(T).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
local msgg = msg_id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id=" .. msg_chat_id .. '&photo=https://t.me/eueeee&caption='.. URL.escape(T).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
--------------------------------------------------------------------------------------------------------------
...
{ 
{ text = '᥀ Developer', url = "https://t.me/EUEEEE" },{ text = '᥀ Twsl Dove', url = "https://t.me/l3lsbot" }
 },
{ 
{ text = '᥀ Exp Source', url = "https://t.me/eee5ef" }
 },
 }
local msgg = msg_id/2097152/0.5
...
if text == (Redis:get(TheKOIA.."KOIA:Name:Bot") or "لار") then
local NamesBot = (Redis:get(TheKOIA.."KOIA:Name:Bot") or "لار")
local NameBots = { 
"عمر "..NamesBot.. " شتريد؟",
"أჂ̤ أჂ̤ هياتني اني",
"موجود بس لتصيح",
"لتلح دا احجي ويه بنات لار بعدين اجاوبك",
...
local CmdStart = '*\n᥀︙اهلاً بك في بوت '..(Redis:get(TheKOIA.."KOIA:Name:Bot") or "لار")..
...
local TextHelp = [[*
᥀︙اوامر الحمايه الخاصه بالمجموعه ↫ ⤈
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
