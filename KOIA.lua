...
keyboard.inline_keyboard = {
{
{text = '᥀ Source Channel', url = "https://t.me/E5EEEF"},{text = '᥀ Twsl Dove', url = "https://t.me/L3LSBot"}
},
{
{text = '᥀ Developer', url = "https://t.me/EUEEEE"}
},
{
...
{
{text = 'اوامر المطورين', data = msg.sender.user_id..'/help5'}, {text = 'العاب البوت', data = msg.sender.user_id..'/help6'}, 
},
{
...
"أჂ̤ أჂ̤ هياتني اني",
"موجود بس لتصيح",
"لتــلح دا احجي ويه بنات لار بعدين اجاوبك",
...
{
{text = 'اوامر المطورين', data = IdUser..'/help5'}, {text = 'العاب البوت', data = IdUser..'/help6'}, 
},
{
